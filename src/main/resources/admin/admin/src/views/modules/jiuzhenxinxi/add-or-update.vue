<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="就诊编号" prop="jiuzhenbianhao">
            <el-input v-model="ruleForm.jiuzhenbianhao" 
                placeholder="就诊编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiuzhenbianhao" label="就诊编号" prop="jiuzhenbianhao">
              <el-input v-model="ruleForm.jiuzhenbianhao" 
                placeholder="就诊编号" readonly></el-input>
          </el-form-item>
        </div>
